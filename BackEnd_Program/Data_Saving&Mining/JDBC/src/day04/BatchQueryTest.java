...
public class BatchQueryTest {
	...
	public static void main(String[] args) throws Exception {
		...
		st.addBatch("insert into memo values(memo_seq.nextval, 'ewr4', 'BatchTest4', sysdate)");
		st.addBatch("insert into memo values(memo_seq.nextval, 'ewr5', 'BatchTest5', sysdate)");
		st.addBatch("insert into memo values(memo_seq.nextval, 'ewr5', 'BatchTest6', sysdate)");

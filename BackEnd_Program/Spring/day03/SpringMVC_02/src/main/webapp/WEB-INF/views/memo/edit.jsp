...
<body>
<div id="wrap" class="container" class="container py-5">
...
<c:if test="${memo ne null }">
	<form name="frm" action="MemoEdit" method="post">
		<table class="table mt-3">
			<tr class="table-info">
				<th colspan="2" class="text-center"> <h1>::한줄 메모장 수정::</h1> </th>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="80%">
					<input type="text" name="name"  value="${memo.name}" class="form-control" placeholder="Name">
				</td>
			</tr>
			<tr>
				<td width="20%"><b>메모 내용</b></td>
				<td width="80%">
					<input type="text" name="msg"  value="${memo.msg}" class="form-control"  placeholder="Message">
				</td>
			</tr>
			<tr>
				<td colspan="2" class="text-center">
					...
					<button type="button" class="btn btn-success" onclick="location.href='memoList'">글 목록</button>
				</td>
			</tr>
		</table>	
	</form>
